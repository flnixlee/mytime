...
import com.lift.ejb.common.GetUseInfo;
import com.lift.ejb.dto.resp.Article;
import com.lift.ejb.dto.resp.Image;
import com.lift.ejb.dto.resp.ImageMessage;
import com.lift.ejb.dto.resp.NewsMessage;
import com.lift.ejb.util.HttpPostUploadUtil;
...
public class EventDispatcher {
	...
	public static String processEvent(Map<String, String> map) {
		...
		System.out.println("公众号原始ID:" + openid);
		...
		if (map.get("Event").equals(MessageUtil.EVENT_TYPE_SUBSCRIBE)) { // 关注事件
			...
			try {
				...
				article.setDescription("欢迎来到凤腾工作室：凤腾资源分享！"); // 图文消息的描述
		...
		if (map.get("Event").equals(MessageUtil.EVENT_TYPE_CLICK)) { // 自定义菜单点击事件
			...
			if (map.get("EventKey").equals("image")) {
				...
				String filepath = System.getProperty("user.dir") + "/mytime/src/main/webapp/images/lift_020.png";
				Map<String, String> textMap = new HashMap<String, String>();
				textMap.put("name", "FlnixLee");
				...
				article.setPicUrl("http://mytime.ngrok.natapp.cn/images/lift_020.png"); // 图文消息图片地址
